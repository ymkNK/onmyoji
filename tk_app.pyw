...
class App:
    ...
    def hotKey_bind(self):
        ...
        partial_register(('ctrl', 'w'), callback=lambda e: self.write_info())
        partial_register(('ctrl', 'c'), callback=lambda e: self.destroy())
        partial_register(('ctrl', 'r'), callback=lambda e: self.func_start())
        partial_register(('ctrl', 'p'), callback=lambda e: self.pause())
        partial_register(('ctrl', 's'), callback=lambda e: self.save_config_as_default())
        partial_register(('ctrl', 'shift', 's'), callback=lambda e: self.save_config_to_file())
        partial_register(('ctrl', 't'), callback=lambda e: self.set_top_window(is_click=False))
        partial_register(('ctrl', 'shift', 'c'), callback=lambda e: self.change_overtime_check(is_click=False))
        partial_register(('ctrl', 'l'), callback=lambda e: self.load_default_config())
        partial_register(('ctrl', 'shift', 'l'), callback=lambda e: self.load_user_config())
        partial_register(('ctrl', 'k'), callback=lambda e: self.update_functions())
        partial_register(('ctrl', 'n'), callback=lambda e: self.combine_single_load())
        partial_register(('ctrl', 'shift', 'n'), callback=lambda e: self.combine_multiple_load())
        partial_register(('ctrl', 'shift', 'a'), callback=lambda e: self.combine_auto_load())
        partial_register(('ctrl', 'd'), callback=lambda e: self.set_two_win_left())
    # '''
