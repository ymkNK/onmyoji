...
class App:
    ...
    def hotKey_bind(self):
        ...
        partial_register(('control', 'shift', 's'), callback=lambda e: self.save_config_to_file())
        partial_register(('control', 't'), callback=lambda e: self.set_top_window(is_click=False))
        partial_register(('control', 'shift', 'c'), callback=lambda e: self.change_overtime_check(is_click=False))
        partial_register(('control', 'l'), callback=lambda e: self.load_default_config())
        partial_register(('control', 'shift', 'l'), callback=lambda e: self.load_user_config())
        partial_register(('control', 'k'), callback=lambda e: self.update_functions())
        partial_register(('control', 'n'), callback=lambda e: self.combine_single_load())
        partial_register(('control', 'shift', 'n'), callback=lambda e: self.combine_multiple_load())
        partial_register(('control', 'shift', 'a'), callback=lambda e: self.combine_auto_load())
        partial_register(('control', 'd'), callback=lambda e: self.set_two_win_left())
    # '''
